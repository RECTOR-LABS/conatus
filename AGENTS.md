...
**Latest handoff (detailed):** `~/Documents/secret/strategy/conatus/session-handoff-2026-08-04.md` (prize DocuSign signed + reviewed; LLM→OpenRouter/GLM-5.3-flash; prod env swapped; **addendum: test transfer + payout timing**). Older handoffs (2026-07-19: GLM-5.2/Ollama + IPFS/Pinata) + spec/plan docs in the same dir. Read the latest handoff first when resuming.
